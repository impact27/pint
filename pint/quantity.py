...
class _Quantity(PrettyIPython, SharedRegistryObject):
    ...
    def _iadd_sub(self, other, op):
        ...
        if not isinstance(other, _Quantity) and _eq(other, 0, True):
            try:
    ...
    def __pow__(self, other):
        ...
        try:
            ...
            if other == 1:
                ...
                if getattr(other, 'dimensionless', False):
                    other = other.to_root_units()
                    units = new_self._units ** other.magnitude
            ...
            magnitude = new_self._magnitude ** _to_magnitude(
                    getattr(other, 'magnitude', other), self.force_ndarray)
            return self.__class__(magnitude, units)
    ...
    def inputs_without_units(self, uf, objs):
